...
public class VerticalStepView extends LinearLayout implements VerticalStepViewIndicator.OnDrawIndicatorListener {
    ...
    public VerticalStepViewIndicator getStepsViewIndicator() {
        return mStepsViewIndicator;
    }
    ...
    public void ondrawIndicator() {
        ...
        if (mTexts != null) {
            for (int i = 0; i < mTexts.size(); i++) {
                ...
                textView.setText(Html.fromHtml(mTexts.get(i)));
                textView.setY(complectedXPosition.get(i) - mStepsViewIndicator.getCircleRadius() / 2 - 10);
